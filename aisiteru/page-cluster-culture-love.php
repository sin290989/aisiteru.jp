<?php
/*
Template Name: Cluster Culture - Love
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
恋愛は単なる個人の感情ではなく、出会いの仕組み、関係性の形成、社会的規範や文化的価値観と結びついた文化構造の一部です。
本クラスタは、構造クラスタ「文化」の下位テーマとして、AI8社の視点から「恋愛観の変化」「関係性の非対称性」「制度と感情の接続」といった論点を構造的に比較した記事のみを収録しています。
正解や善悪を提示するためではなく、恋愛が社会の中でどのように形成され、変化しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「文化」に属する<strong>恋愛</strong>テーマの記事を時系列で表示しています。
</p>
