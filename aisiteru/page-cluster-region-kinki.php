<?php
/*
Template Name: Cluster Region - Kinki
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
近畿地方は、歴史都市と商業都市が重層的に共存し、文化・経済・観光が複雑に絡み合う広域圏です。
本クラスタは、構造クラスタ「地域」の下位テーマとして、AI8社の視点から「歴史都市の蓄積」「商業文化の形成」「地域間の役割分担」といった論点を構造的に比較した記事のみを収録しています。
正解や善悪を提示するためではなく、近畿という広域圏がどのように機能しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「地域」に属する<strong>近畿地方</strong>テーマの記事を時系列で表示しています。
</p>
