<?php
/*
Template Name: Cluster Event - FIFA World Cup
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
FIFAワールドカップは世界最大級のスポーツイベントとして認識される一方で、その成立は単なる競技大会にとどまりません。大会の統治構造、放映権やスポンサーによる収益設計、各国サッカー協会との関係、そして国家やメディアによる意味付けなど、複数の構造要素が重なり合って形成されています。
本クラスタは、構造クラスタ「イベント」の下位テーマとして、AI8社の視点から「統治と権力構造」「競技と商業の接続」「国家とメディアの関係」といった論点を横断的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、FIFAワールドカップというイベントがどのような社会的枠組みの中で成立しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「イベント」に属する<strong>FIFAワールドカップ</strong>テーマの記事を時系列で表示しています。
</p>
