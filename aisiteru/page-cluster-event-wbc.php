<?php
/*
Template Name: Cluster Event - WBC
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
WBCは国際野球大会として語られることが多い一方で、大会運営の制度設計、放映権やスポンサー構造、各国リーグとの関係、ナショナルアイデンティティの表象といった複数の構造要素によって形成されています。
本クラスタは、構造クラスタ「イベント」の下位テーマとして、AI8社の視点から「大会制度の設計」「競技と商業の関係」「国家とメディアの接続」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、WBCというイベントがどのような社会的枠組みの中で成立しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「イベント」に属する<strong>WBC</strong>テーマの記事を時系列で表示しています。
</p>
