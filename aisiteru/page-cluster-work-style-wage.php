<?php
/*
Template Name: Cluster Work Style - Wage
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
賃金は、個人の能力や努力の結果として語られることが多い一方で、労働市場、制度設計、産業構造、技術革新といった構造的要因によって大きく形成されています。
本クラスタは、構造クラスタ「働き方」の下位テーマとして、AI8社の視点から「賃金決定の構造」「市場と制度の関係」「働き方と報酬の変化」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、賃金がどのような社会的枠組みの中で形成されているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「働き方」に属する<strong>賃金</strong>テーマの記事を時系列で表示しています。
</p>
