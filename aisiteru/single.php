...
?>
<div class="inner">
<a href="/"><span class="home">トップページ</span></a> > <a href="/blog">ブログ</a> > <a href="<?php echo $link; ?>"><?php echo $catname; ?></a> > <span class="now"><?php the_title(); ?></span>
</div>
</div>
...
<div class="post-dates">
    ...
    ?>
        更新日:<time class="updated" datetime="<?php the_modified_date("Y-m-d H:i:s") ?>"><?php the_modified_date('Y.n.j') ?>（公開:<?php echo get_the_date('Y.n.j') ?>）</time>
    <?php
    }else{
    ?>
        更新日:<time class="entry-date published" datetime="<?php echo get_the_date("Y-m-d H:i:s") ?>"><?php echo get_the_date('Y.n.j') ?></time>
