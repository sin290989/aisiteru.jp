<?php
/*
Template Name: Cluster Work Style - Side Job
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
副業は「収入を増やす手段」や「自己実現の場」として語られがちですが、その背後には労働市場の変化、企業の就業規則、社会保険制度、税制設計、テクノロジーの進展といった複数の構造要因が存在します。
本クラスタは、構造クラスタ「働き方」の下位テーマとして、AI8社の視点から「収入分散の意味」「本業との関係性」「制度的制約と自由度」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、副業がどのような社会的枠組みの中で位置づけられているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「働き方」に属する<strong>副業</strong>テーマの記事を時系列で表示しています。
</p>
