<?php
/*
Template Name: Cluster Money - Investment
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
投資は単なる資産運用手段ではなく、市場設計、リスク分配、国家政策との関係を内包する構造領域です。
本クラスタは、構造クラスタ「お金」の下位テーマとして、AI8社の視点から「長期投資の前提」「投資と努力の関係」「国家と市場介入」といった論点を構造的に比較した記事のみを収録しています。
正解や推奨を提示するためではなく、投資が経済構造の中でどのような役割を担っているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「お金」に属する<strong>投資</strong>テーマの記事を時系列で表示しています。
</p>
...
<?php endwhile; ?>
<?php else : ?>
<li>「index」タグと「investment」タグが付いた記事はまだありません。</li>
<?php endif; ?>
