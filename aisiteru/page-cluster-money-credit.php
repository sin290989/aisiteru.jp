<?php
/*
Template Name: Cluster Money - Credit
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
ローンは単なる借入手段ではなく、信用創造の仕組み、金利設計、家計・企業・国家の負債構造と結びついた金融構造の一部です。
本クラスタは、構造クラスタ「お金」の下位テーマとして、AI8社の視点から「信用の成立条件」「金利と時間価値」「債務とリスク配分」といった論点を構造的に比較した記事のみを収録しています。
正解や善悪を提示するためではなく、ローンが経済構造の中でどのような役割を担っているのかを読み解くための座標としてご利用ください。
</p>
...
<?php endwhile; ?>
<?php else : ?>
<li>「index」タグと「credit」タグが付いた記事はまだありません。</li>
<?php endif; ?>
