<?php
/*
Template Name: Cluster Politics
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<div id="main-cluster">
<h1 class="h-index">政治</h1>

<p class="top-read">
このページは、AI比較クラスタの中でも、<strong>「政治」という構造領域に属するテーマ群を束ねた構造クラスタページ</strong>です。<br>
権力構造、制度設計、意思決定プロセス、選挙制度といった観点から、政治がどのように社会の中で機能しているのかを、多角的な視点から整理しています。<br>
