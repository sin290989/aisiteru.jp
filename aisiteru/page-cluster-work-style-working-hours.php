<?php
/*
Template Name: Cluster Work Style - Working Hours
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
労働時間は「長い・短い」といった印象論で語られがちですが、その背後には法制度、企業の運用、評価や賃金体系、業務設計、技術変化といった複数の構造要因が存在します。
本クラスタは、構造クラスタ「働き方」の下位テーマとして、AI8社の視点から「労働時間制度の設計」「成果・生産性との接続」「裁量と負荷の配分」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、労働時間がどのような社会的枠組みの中で形作られているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「働き方」に属する<strong>労働時間</strong>テーマの記事を時系列で表示しています。
</p>
