...
if (function_exists('wpp_get_mostpopular')) {
    wpp_get_mostpopular(array(
        'title' => 'アクセスランキング',
        'post_type' => 'tech', // カスタム投稿タイプ「tech」を指定
        'limit' => 5, // 表示する投稿数
        'thumbnail_width' => 120, // サムネイル幅
        'thumbnail_height' => 80, // サムネイル高さ
...
echo '<li>';
echo '<a href="/tech-category/web/">WEB制作</a>';
echo '<ul>';
echo '<li><a href="/tech-category/html-css/">html・CSS</a></li>';
echo '<li><a href="/tech-category/javascript/">JavaScript</a></li>';
echo '<li><a href="/tech-category/php/">PHP</a></li>';
echo '<li><a href="/tech-category/wordpress/">WordPress</a></li>';
echo '<li><a href="/tech-category/git-github/">Git・GitHub</a></li>';
echo '<li><a href="/tech-category/htaccess/">.htaccess</a></li>';
echo '</ul>';
echo '</li>';
echo '</ul>';
?>
