...
<ul class="post-index">
    <?php if ( $index_query->have_posts() ) : ?>
        ...
        <?php endwhile; ?>
    <?php else : ?>
        <li>「index」＋「j-league」タグの記事はまだありません。</li>
    <?php endif; ?>
...
<div class="more-btn">
  <a href="/cluster/culture/j-league/">
    <span>Jリーグクラスタページへ</span>
  </a>
</div>
