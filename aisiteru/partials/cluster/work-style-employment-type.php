...
// employment-type ＋ index 両方が付いた最新3件を取得
$args = array(
    'post_type'      => 'post',
    'posts_per_page' => 3,
...
<div class="more-btn">
  <a href="/cluster/work-style/employment-type/">
    <span>雇用形態クラスタページへ</span>
  </a>
</div>
</div>
<!------------------------------------------------------------------------------>
