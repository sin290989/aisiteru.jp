...
// 前の記事を取得（WEBのきほん専用）
$prev_args = array(
    'post_type' => 'basic', // カスタム投稿タイプ「basic」
    'posts_per_page' => 1,
    'orderby' => 'date',
    'order' => 'DESC',
    'post_status' => 'publish',
...
<?php else: ?>
    <div class="prev-link top">
        <a href="<?php echo home_url('/basic/'); ?>">
            <div class="top-text">トップに戻る</div>
            <div class="top-con">
                <h3 class="item-title">「WEBのきほん」の記事では、この投稿が一番古い記事です。</h3>
            </div>
        </a>
    </div>
<?php endif; ?>
...
<?php else: ?>
    <div class="next-link top">
        <a href="<?php echo home_url('/basic/'); ?>">
            <div class="top-text">トップに戻る</div>
            <div class="top-con">
                <h3 class="item-title">「WEBのきほん」の記事では、この投稿が最新です。</h3>
            </div>
        </a>
    </div>
<?php endif; ?>
