<?php
/*
Template Name: Cluster Education - Certification
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
資格は単なるスキル証明ではなく、能力の可視化、評価基準の設計、社会との接続といった複数の構造要素によって成立しています。
本クラスタは、構造クラスタ「教育」の下位テーマとして、AI8社の視点から「資格の意味」「証明と信頼の関係」「制度としての評価構造」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、資格制度がどのような社会的枠組みの中で機能しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「教育」に属する<strong>資格（certification）</strong>テーマの記事を時系列で表示しています。
</p>
