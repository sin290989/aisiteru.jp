<?php
/*
Template Name: Cluster Event - Koshien
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
甲子園は高校野球大会として広く知られていますが、その背景には学校制度、学生スポーツの位置づけ、大会運営の仕組み、テレビ報道や地域社会の期待など複数の構造要素が存在しています。
本クラスタは、構造クラスタ「イベント」の下位テーマとして、AI8社の視点から「教育制度と競技の関係」「大会運営とメディア報道」「地域社会と高校野球文化」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、甲子園というイベントがどのような社会構造の中で成立しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「イベント」に属する<strong>甲子園</strong>テーマの記事を時系列で表示しています。
</p>
