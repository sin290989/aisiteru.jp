<?php
/*
Template Name: Cluster Region - Kanto
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
>
<a href="/cluster/region/">地域クラスタ</a>
>
<?php the_title(); ?>
</div>
</div>
...
<p class="read">
関東地方は単なる地域の集合ではなく、都市圏の形成、人口集中、経済活動の連動といった複数の構造が重なり合う広域圏です。
本クラスタは、構造クラスタ「地域」の下位テーマとして、AI8社の視点から「首都圏の形成」「通勤・居住構造」「地域間の役割分担」といった論点を構造的に比較した記事のみを収録しています。
正解や善悪を提示するためではなく、関東という広域圏がどのように機能しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「地域」に属する<strong>関東地方</strong>テーマの記事を時系列で表示しています。
</p>
...
<div class="back-btn">
<a href="/cluster/region/">地域クラスタへ<span>戻る</span></a>
</div>
