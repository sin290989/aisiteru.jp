<?php
/*
Template Name: Cluster Culture - Game
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
ゲームは単なる娯楽ではなく、ルール設計、プレイヤーの意思決定、報酬構造、そして社会的・文化的背景と結びついた複合的な構造を持っています。
本クラスタは、構造クラスタ「文化」の下位テーマとして、AI8社の視点から「ゲームデザイン」「プレイヤー心理」「課金構造」「コミュニティ形成」といった論点を構造的に比較した記事のみを収録しています。
正解や優劣を提示するためではなく、ゲームという現象がどのような構造の上に成立しているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「文化」に属する<strong>ゲーム</strong>テーマの記事を時系列で表示しています。
</p>
