<?php
/*
Template Name: Cluster Work Style - Career
*/
?>
<!DOCTYPE html>
<html lang="ja">
...
<p class="read">
キャリアは、個人の意思や努力だけではなく、教育制度、労働市場、企業構造、社会環境といった構造的要因の影響を強く受けながら形成されます。
本クラスタは、構造クラスタ「働き方」の下位テーマとして、AI8社の視点から「キャリア形成の構造」「教育と市場の関係」「働き方の変化とキャリア選択」といった論点を構造的に比較した記事のみを収録しています。
正解や価値観を提示するためではなく、キャリアがどのような社会的枠組みの中で形成されているのかを読み解くための座標としてご利用ください。
</p>

<p class="cluster-rule">
このクラスタには、構造クラスタ「働き方」に属する<strong>キャリア</strong>テーマの記事を時系列で表示しています。
</p>
...
// career タグ
$season_tag = get_term_by( 'slug', 'career', 'post_tag' );
...
<?php endwhile; ?>
<?php else : ?>
<li>「index」タグと「career」タグが付いた記事はまだありません。</li>
<?php endif; ?>
